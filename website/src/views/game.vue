<template>
  <html>
    <head>
      ...
      <link rel="apple-touch-startup-image" href="meta/apple-touch-startup-image-640x920.png" media="(device-width: 320px) and (device-height: 480px) and (-webkit-device-pixel-ratio: 2)"> <!-- iPhone retina 顯示屏 -->
    ...
    <body>
      <!-- 警告提示，用戶將側邊欄的寬度調整為更適合的大小 -->
      <div class="warning">
        <strong>Please further increase the width of your sidebar for the best experience playing this game!</strong>
      </div>
